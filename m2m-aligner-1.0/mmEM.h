...
typedef map<string, hash_StrDouble> hash_2StrDouble; //lhuang: probs
#endif
...
class mmEM
{
	...
	hash_2StrDouble alphas;

    //lhuang
	hash_2StrDouble index; // mapping from (x,y) to index
...
public:
  ...
  //declaring functions for computing P(X | Y)
  void computeDataProbs(param myParam);
  long double computePairProb(param, vector_str, vector_str);
